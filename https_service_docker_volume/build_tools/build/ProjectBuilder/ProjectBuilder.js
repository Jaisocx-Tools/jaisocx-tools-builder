...
class ProjectBuilder {
    ...
    prettifyWithEslint(eslintConfigCatalogPath, pathToEslint) {
        const result = (0, child_process_1.execSync)(`npx eslint ${pathToEslint} --fix`, this.getSpawnSyncPayload(eslintConfigCatalogPath));
        //console.log(result);
    }
}
